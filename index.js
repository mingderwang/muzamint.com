...
module.exports = dispatch()
  ...
  .dispatch("/privacy", "*", (req, res, { params, query }) => {
    return { "we never ask for your any data": true };
  })
  .dispatch("/terms", "*", (req, res, { params, query }) => {
    return { "use on your own risk": true };
  })
  .otherwise((req, res) => {
    return "404";
  });
